 ...
 * $RCSfile$
 * $Revision: 2579 $
 * $Date: 2005-02-08 22:48:59 +0100 (mar 08 de feb de 2005) $
 *
 ...
 * the Java system property "stroke.componentManagerClass". The value of the
...
public class ComponentManagerFactory {
    ...
    public static synchronized ComponentManager getComponentManager() {
        ...
        String className = System.getProperty("stroke.componentManagerClass");
        if (className != null) {
            try {
